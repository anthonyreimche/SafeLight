...
// structures instead of shipping binary fixtures via the typed builder in
// tiff-fixture.ts (shared with the export EXIF writer tests). Everything is
// asserted through the public parseExif / parseXmp / parseExifDate surface.
// Run with `npm test`.
